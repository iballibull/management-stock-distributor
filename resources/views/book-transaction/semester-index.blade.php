@extends('layouts.app', ['metaTitle' => 'Semester', 'parentSection' => 'bookTransaction', 'elementName' => 'semester'])
    ...
    @component('layouts.headers.breadcrumbs')
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('semester.index') }}"><span
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('semester.index') }}"><span
                        ...
                        aria-current="page">Semester</span></a>
            </div>
        </li>
    @endcomponent
                    ...
                    <div class="items-center mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                        <form class="lg:pr-3" action="" method="GET">
                            ...
                            <div class="relative mt-1 lg:w-64 xl:w-96">
                                <input type="text" name="name" id="users-search" value="{{ request('name') ?? '' }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Cari nama semester" autocomplete="off">
                            </div>
                        </form>
                    </div>
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        <button type="button" data-modal-target="add-semester-modal" data-modal-toggle="add-semester-modal"
                                ...
                                @foreach ($semesters as $key => $semester)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <td
                                            ...
                                            {{ $semesters->firstItem() + $key }}
                                        <td
                                            class="px-6 py-4 w-[200px] text-gray-900 font-medium dark:text-white text-center">
                                            {{ $semester->name }}</td>
                                        <td
                                            class="px-6 py-4 w-[200px] text-gray-900 font-medium dark:text-white text-center">
                                            {{ Illuminate\Support\Carbon::parse($semester->start_date)->locale('id')->translatedFormat('d F Y') }}
                                        </td>
                                        <td
                                            class="px-6 py-4 w-[200px] text-gray-900 font-medium dark:text-white text-center">
                                            {{ Illuminate\Support\Carbon::parse($semester->end_date)->locale('id')->translatedFormat('d F Y') }}

                                        <td
                                            class="px-6 py-4 w-[300px] text-gray-900 font-medium dark:text-white text-center">
                                            <div class="inline-flex items-center gap-2">
                                                <button type="button" data-modal-target="edit-semester-{{ $semester->id }}"
                                                    data-modal-toggle="edit-semester-{{ $semester->id }}"
                                                ...
                                                <button type="button"
                                                    data-modal-target="delete-semester-modal{{ $semester->id }}"
                                                    data-modal-toggle="delete-semester-modal{{ $semester->id }}"
                                    ...
                                    <div class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black/30 overflow-x-hidden overflow-y-auto"
                                        ...
                                        <div class="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto p-4">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <div class="p-6">
                                                    <form
                                                        action="{{ route('semester.update', ['semesterId' => $semester->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('PUT')
                                                            ...
                                                            <div class="w-full max-w-md">
                                                                <div class="grid grid-cols-1 gap-6">
                                                                    <div class="relative">
                                                                        ...
                                                                        <div class="my-4">
                                                                            <label for="semester_number"
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Semester
                                                                                <span class="text-red-500">*</span></label>
                                                                            <select id="semester_number"
                                                                                name="semester_number" required
                                                                                class="bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-600 focus:border-blue-600 text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"">
                                                                                <option selected="" value="">
                                                                                    Pilih Semester</option>
                                                                                <option value="1"
                                                                                    @selected($semester->semester_number == '1')>1</option>
                                                                                <option value="2"
                                                                                    @selected($semester->semester_number == '2')>2</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="fixed inset-0 z-50 flex items-center justify-center min-h-screen hidden overflow-x-hidden overflow-y-auto"
                                        id="delete-semester-modal{{ $semester->id }}">
                                        <div class="relative w-full max-w-md px-4">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <div class="flex justify-end p-2">
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                                                        data-modal-hide="delete-semester-modal{{ $semester->id }}">
                                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd"
                                                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                                ...
                                                <div class="p-6 pt-0 text-center">
                                                    <form
                                                        action="{{ route('semester.destroy', ['semesterId' => $semester->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        ...
                                                        <h3 class="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">
                                                            Yakin ingin menghapus semester <b>{{ $semester->name }}</b>?
                                                        </h3>
            ...
            <div class="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto p-4">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <div
                        ...
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                            data-modal-toggle="add-semester-modal">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                    ...
                                    <div class="grid grid-cols-1 gap-6">
                                        <div class="relative">
                                            ...
                                            <div>
                                                ...
                                                <input type="number" id="year" name="year" min="2020"
                                                    max="2030" placeholder="Masukkan tahun"
                                                    value="{{ old('year', date('Y')) }}" required autocomplete="off"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            </div>
                                            <div class="my-4">
                                                <label for="semester_number"
