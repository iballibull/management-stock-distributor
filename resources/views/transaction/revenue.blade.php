@extends('layouts.app', ['metaTitle' => 'Pendapatan', 'parentSection' => 'transaction', 'elementName' => 'Pendapatan'])
...
@section('content')
    @component('layouts.headers.breadcrumbs')
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('transaction.revenue.index') }}"><span
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('transaction.revenue.index') }}"><span
                        ...
                        aria-current="page">Pendapatan</span></a>
            </div>
        </li>
    @endcomponent
    ...
    <div class="col-span-full">
        <div class="space-y-6">
            ...
            <!-- Filters -->
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <form method="GET" action="{{ route('transaction.revenue.index') }}"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 whitespace-nowrap">Sisa Bayar</th>
