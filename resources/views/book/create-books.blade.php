@extends('layouts.app', ['metaTitle' => 'Tambah Buku', 'parentSection' => 'book', 'elementName' => 'books'])
    ...
    @component('layouts.headers.breadcrumbs')
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('books.create') }}"><span
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div>
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="Judul Buku" autocomplete="off" value="{{ old('title') }}" required="">
                        ...
                        <div>
                            ...
                            <select id="education_level_id" name="education_level_id" required
                                ...
                                @foreach ($educationLevels as $id => $name)
                                    <option value="{{ $id }}"
                                        {{ old('education_level_id') == $id ? 'selected' : '' }}>
                                        {{ $name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="price" id="price"
                                ...
                                placeholder="Harga Buku" autocomplete="off" value="{{ old('price') }}" required>
                            @error('price')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                    <span class="font-medium">{{ $message }}</span>
                                </p>
                        ...
                        <div>
                            ...
                            <select id="grade_number" name="grade_number" required
                                ...
                                <option value="1" @selected(old('grade_number') == '1')>1</option>
                                <option value="2" @selected(old('grade_number') == '2')>2</option>
                                <option value="3" @selected(old('grade_number') == '3')>3</option>
                                <option value="4" @selected(old('grade_number') == '4')>4</option>
                                <option value="5" @selected(old('grade_number') == '5')>5</option>
                                <option value="6" @selected(old('grade_number') == '6')>6</option>
                                <option value="7" @selected(old('grade_number') == '7')>7</option>
                                <option value="8" @selected(old('grade_number') == '8')>8</option>
                                <option value="9" @selected(old('grade_number') == '9')>9</option>
                                <option value="10" @selected(old('grade_number') == '10')>10</option>
                                <option value="11" @selected(old('grade_number') == '11')>11</option>
                                <option value="12" @selected(old('grade_number') == '12')>12</option>
                                <option value="BESAR" @selected(old('grade_number') == 'BESAR')>BESAR</option>
                                <option value="KECIL" @selected(old('grade_number') == 'KECIL')>KECIL</option>
                            </select>
                            @error('grade_number')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                    <span class="font-medium">{{ $message }}</span>
