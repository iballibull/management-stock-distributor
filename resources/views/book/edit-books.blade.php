@extends('layouts.app', ['metaTitle' => 'Edit Buku', 'parentSection' => 'book', 'elementName' => 'books'])
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="price" id="price"
                                ...
                                placeholder="Harga Buku" autocomplete="off"
                                value="{{ old('price', number_format($book->price, 0, ',', '')) }}" required>
                            @error('price')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                    <span class="font-medium">{{ $message }}</span>
                                </p>
