@extends('layouts.app', ['metaTitle' => 'Kategori', 'parentSection' => 'book', 'elementName' => 'category'])
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('category.index') }}"><span
                        ...
                        aria-current="page">Kategori</span></a>
            </div>
        </li>
    @endcomponent
                        ...
                        <table
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="px-6 py-4 w-[50px] text-gray-900 font-medium dark:text-white text-center">1
                                    </td>
                                    <td class="px-6 py-4 w-[200px] text-gray-900 font-medium dark:text-white text-center">
                                        nama</td>
                                    <td class="px-6 py-4 w-[300px] text-gray-900 font-medium dark:text-white text-center">
                                        <div class="inline-flex items-center gap-2">
                                            <button type="button" data-modal-target="edit-category-modal"
                                            ...
                                            <button type="button" data-modal-target="delete-category-modal"
                                ...
                                <div class="w-full max-w-md">
                                    <div class="grid grid-cols-1 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="edit_name" placeholder="nama kategori"
