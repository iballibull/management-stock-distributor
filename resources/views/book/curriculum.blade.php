@extends('layouts.app', ['metaTitle' => 'Kurikulum', 'parentSection' => 'book', 'elementName' => 'curriculum'])
            ...
            <div class="w-full mb-1">
                <div class="sm:flex">
                    ...
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        <button type="button" data-modal-target="add-curriculum-modal"
                            data-modal-toggle="add-curriculum-modal"
            ...
            <div class="overflow-x-auto">
                <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden shadow">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @foreach ($curriculums as $key => $curriculum)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            ...
                                            <div class="inline-flex items-center gap-2">
                                                <button type="button"
                                                    data-modal-target="edit-curriculum-modal{{ $curriculum->id }}"
                                                    data-modal-toggle="edit-curriculum-modal{{ $curriculum->id }}"
                                                ...
                                                <button type="button"
                                                    data-modal-target="delete-curriculum-modal{{ $curriculum->id }}"
                                                    data-modal-toggle="delete-curriculum-modal{{ $curriculum->id }}"
                                    ...
                                    <div class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black/30 overflow-x-hidden overflow-y-auto"
                                        id="edit-curriculum-modal{{ $curriculum->id }}">
                                        <div class="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto p-4">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <div class="p-6">
                                                    <form
                                                        action="{{ route('curriculum.update', ['curriculumId' => $curriculum->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('PUT')
                                                                ...
                                                                <div class="grid grid-cols-1 gap-6">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="text" id="edit_name"
                                                                            placeholder="nama kurikulum" name="name"
                                    ...
                                    <div class="fixed inset-0 z-50 flex items-center justify-center min-h-screen hidden overflow-x-hidden overflow-y-auto"
                                        id="delete-curriculum-modal{{ $curriculum->id }}">
                                        <div class="relative w-full max-w-md px-4">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <div class="flex justify-end p-2">
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                                                        data-modal-hide="delete-curriculum-modal{{ $curriculum->id }}">
                                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd"
                                                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                                ...
                                                <div class="p-6 pt-0 text-center">
                                                    <form
                                                        action="{{ route('curriculum.destroy', ['curriculumId' => $curriculum->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        ...
                                                        <h3 class="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">
                                                            Yakin ingin menghapus kurikulum <b>{{ $curriculum->name }}</b>?
                                                        </h3>
                        ...
                        {{ $curriculums->links('pagination::tailwind') }}
                    </div>
                </div>
            </div>
        </div>
