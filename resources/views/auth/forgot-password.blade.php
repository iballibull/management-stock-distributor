@extends('layouts.guest', ['metaTitle' => 'Lupa Password'])
@section('content')
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    @if (session('status'))
                        <div id="alert-3"
                            ...
                            <div class="ms-3 text-sm font-medium">
                                <span class="font-semibold">Berhasil!</span> Link berhasil dikirim ke email.
                            </div>
                            <button type="button"
                    ...
                    <p class="text-gray-500 mt-0">
                        ...
                        tautan untuk mengatur ulang kata sandi agar Anda dapat membuat yang baru.
                    </p>
